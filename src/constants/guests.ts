...
export const GUESTS: Guest[] = [
    ...
    { formal: 'Juan, Aleja y Juanpa', husband: 'Juan', husbandKeys: ['juan'], wife: 'Aleja', wifeKeys: ['aleja', 'alejandra'], child: 'Juanpa', childKeys: ['juanpa', 'juan'], childPrefix: 'tu hijo' },
    ...
    { formal: 'Sebas y Aleja', husband: 'Sebas', husbandKeys: ['sebas', 'sebastian', 'juan'], wife: 'Aleja', wifeKeys: ['aleja', 'alejandra'] }
];

...
export const GUESTS: Guest[] = [
    ...
    { formal: 'Juan, Aleja y Juanpa', husband: 'Juan', husbandKeys: ['juan', 'sebas', 'sebastian', 'juan sebastian'], wife: 'Aleja', wifeKeys: ['aleja', 'alejandra'], child: 'Juanpa', childKeys: ['juanpa', 'juan'], childPrefix: 'tu hijo' },
